...
/**
 * Register all consolidated Planka kanban tools on the given McpServer.
 * Shared by the stdio entrypoint (index.ts) and the streamable-HTTP
 * server (http-server.ts) so tool definitions live in exactly one place.
 */
